    ...
    columnHelper.accessor('status', {
      ...
      cell: (info) => {
        ...
        const styles: Record<string, string> = {
          ...
          'Arrived At Destination': 'bg-indigo-100 text-indigo-700 border-indigo-200',
          'Out For delivery': 'bg-yellow-100 text-yellow-700 border-yellow-200',
          'Delivered': 'bg-emerald-100 text-emerald-700 border-emerald-200',
          'Failed Attempt': 'bg-rose-100 text-rose-700 border-rose-200',
          'Ready To Return': 'bg-orange-100 text-orange-700 border-orange-200',
          'Return Dispatched': 'bg-cyan-100 text-cyan-700 border-cyan-200',
